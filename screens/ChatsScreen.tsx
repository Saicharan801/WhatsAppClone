...
const chats = [
  ...
  { id: "7", name: "Jagan Mohan Reddy", lastMessage: "og ki veldam aa", time: "8/18/25" },
  { id: "8", name: "Rahul Gandhi", lastMessage: "Pawan Kalyan ni kuda nenu kadu", time: "8/15/25" },
  { id: "9", name: "Sonia Gandhi", lastMessage: "Nuvvu kadu", time: "8/10/25" },
  { id: "10", name: "KCR", lastMessage: "Nenu kadu", time: "8/05/25" },
  { id: "11", name: "Jagan Mohan Reddy", lastMessage: "Nenu kadu", time: "8/01/25" },
];
  ...
  return (
     <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.chatItem} onPress={() => navigation.navigate("Chat", { name: item.name })} >
